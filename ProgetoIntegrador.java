...
public class ProgetoIntegrador {
    ...
    static ArrayList<Pergunta> criaPerguntas() {
        ...
        perguntas.add(new Pergunta("Historia aqui", "O valor em binário do decimal 227 é:", 1, 2, new String[]{"10101000", "10101101", "11100011", "1011110", "1011101"}));
    ...
    private static class Pergunta {
        ...
        public Pergunta(String historia, String enunciado, int pontos, int respostaCorreta, String[] alternativas) {
